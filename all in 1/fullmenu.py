# SmartOps-AI: All-in-One Menu Dashboard (Student Edition)
# -------------------------------------------------------
...
# ------------------ Home ------------------
if selected == "Home":
    st.title("🧠 SmartOps AI Dashboard")
    st.markdown("""
    Welcome to **SmartOps AI**, your all-in-one operational dashboard.
   ...
   # ------------------ Python Tasks ------------------
    ...
    "Make a Call", "Ask Gemini AI", "Scrape Website"])
    ...
    def gemini():
        ...
        if st.button("Ask Gemini"):
            genai.configure(api_key="AIzaSyAahVHydAs0DFICM-DjWezaTWG6CzCkkog")
...
# ------------------ HTML/JS Tasks ------------------
    ...
    if st.button("Launch HTML Task"):
        file_path = os.path.abspath(f"C:/Users/Mahak/Documents/fullstack/{html_options[choice]}")
...
# ------------------ Windows Tasks ------------------
    ...
    st.markdown("---")
    st.caption("🚀 Built with ❤️ by arushi soni")
